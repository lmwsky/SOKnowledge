...
class StanfordDocumentPreprocessor(TokenizerI):
    r"""
    Interface to the Stanford DocumentPreprocessor

    >>> from nltk.tokenize import StanfordTokenizer
    >>> s = "Good muffins cost $3.88\nin New York.  Please buy me\ntwo of them.\nThanks."
    >>> StanfordDocumentPreprocessor().tokenize(s)
