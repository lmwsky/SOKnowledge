...
class TaggedTextForm(forms.Form):
    input_text = forms.CharField(
        widget=forms.Textarea(attrs={'id': 'tagged_text', 'disabled': True, 'class': 'form-control'}))
    post_id = forms.IntegerField(
        widget=forms.NumberInput(attrs={'id': 'post_id_in_form', 'disabled': True, 'class': 'form-control'}))
